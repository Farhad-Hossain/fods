                        ...
                        <div class="card-spacer">
                            ...
                            <div class="row m-0">
                                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7 mb-7">
                                    ...
                                    <a href="<?php echo route('backend.restaurant.list'); ?>" class="text-danger font-weight-bold font-size-h6"><?php echo $total_restaurant; ?> Restaurants</a>
                                </div>
                                <div class="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7">
                                    ...
                                    <a href="<?php echo route('backend.food.list'); ?>" class="text-warning font-weight-bold font-size-h6"><?php echo $total_food; ?> Foods</a>
                                </div>
                                <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                                    ...
                                    <a href="<?php echo route('backend.delivery.driver-list'); ?>" class="text-primary font-weight-bold font-size-h6 mt-2"><?php echo $total_driver; ?> Drivers</a>
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row m-0">
                                <div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
                                    ...
                                    <a href="<?php echo route('backend.order.list'); ?>" class="text-danger font-weight-bold font-size-h6 mt-2"><?php echo $orders->count(); ?> Orders</a>
                                </div>
                                ...
                                <table class="table table-bordered table-hover table-checkable" id="datatable_table" style="margin-top: 13px !important">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b class="text-primary"><?php echo $order->status['status_name']; ?></b>
...
<?php echo $__env->make('backend.master', ['title'=>'Dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/fods/resources/views/backend/dashboard.blade.php ENDPATH**/ ?>