<div class="topbar">
            ...
            <form>
                ...
                <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(assets/media/misc/bg-1.jpg)">
                    ...
                    <h4 class="d-flex flex-center rounded-top">
                        ...
                        <span class="btn btn-text btn-success btn-sm font-weight-bold btn-font-md ml-2"><?php echo e($today_orders->count()); ?> new Orders today</span>
                    </h4>
                    <!--end::Title-->
                    <!--begin::Tabs-->
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                        ...
                        <div class="scroll pr-7 mr-n7" data-scroll="true" data-height="300" data-mobile-height="200">
                            <!--begin::Item-->
                            <?php $__currentLoopData = $today_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="d-flex align-items-center mb-6">
                                ...
                                <div class="d-flex flex-column font-weight-bold">
                                    <a href="#" class="text-dark text-hover-primary mb-1 font-size-lg"><?php echo e($order->details->food->food_name); ?></a>
    ...
    <div class="dropdown">
        ...
        <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
            <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                <img class="h-20px w-20px rounded-sm" src=<?php echo asset('backend/assets'); ?>/media/svg/flags/226-united-states.svg" alt="" />
            </div>
        </div>
        <!--end::Toggle-->
        <!--begin::Dropdown-->
        <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
            ...
            <ul class="navi navi-hover py-4">
                ...
                <li class="navi-item">
                    <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src=<?php echo asset('backend/assets'); ?>/media/svg/flags/226-united-states.svg" alt="" />
													</span>
                ...
                <li class="navi-item active">
                    <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src=<?php echo asset('backend/assets'); ?>/media/svg/flags/128-spain.svg" alt="" />
													</span>
                ...
                <li class="navi-item">
                    <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src=<?php echo asset('backend/assets'); ?>/media/svg/flags/162-germany.svg" alt="" />
													</span>
                ...
                <li class="navi-item">
                    <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src="<?php echo asset('backend/assets'); ?>/media/svg/flags/063-japan.svg" alt="" />
													</span>
                ...
                <li class="navi-item">
                    <a href="#" class="navi-link">
													<span class="symbol symbol-20 mr-3">
														<img src=<?php echo asset('backend/assets'); ?>/media/svg/flags/195-france.svg" alt="" />
													</span>
    ...
    <div class="topbar-item">
        <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
            ...
            <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo Auth::user()->name; ?></span>
...
<?php /**PATH /opt/lampp/htdocs/fods/resources/views/backend/partials/_top_toolbar.blade.php ENDPATH**/ ?>