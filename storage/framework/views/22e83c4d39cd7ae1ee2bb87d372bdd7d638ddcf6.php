...
<html lang="en">
    ...
    <head><base href="../../../">
        ...
        <!--end::Layout Themes-->
        <link rel="shortcut icon" href="<?php echo asset('uploads'); ?>/logo/<?php echo e($gd['globals']->address_bar_icon); ?>" />
            ...
            <div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
                ...
                <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                    ...
                    <div class="mx-auto w-75">
                        <img src="<?php echo e(asset('uploads/logo').'/'.$gd['globals']->login_page_cover_photo); ?>" class="w-100">
                    </div>
                    <!--end::Aside Bottom-->
                </div>
...
<?php /**PATH /opt/lampp/htdocs/fods/resources/views/backend/auth/adminLogin.blade.php ENDPATH**/ ?>