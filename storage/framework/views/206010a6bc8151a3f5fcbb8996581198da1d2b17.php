        ...
        <div class="row">
            <div class="col-md-2 col-sm-12 col-xs-12">
                <div class="menu-left text-center text-md-left">
                    <div class="logo-box">
                        <a href="<?php echo route('frontend.home'); ?>">
                            <img src="<?php echo asset('uploads'); ?>/logo/<?php echo e($gd['globals']->website_logo); ?>" alt="Logo" height="40px;">
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light menu-right">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mr-auto nav-text">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(route('frontend.howToOrder')); ?>">How To Orders?</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo route('frontend.become-a-partner'); ?>">Partners</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="icons-set">
                        <ul class="list-inline">
                                        ...
                                        <div class="notification-details">
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img src="<?php echo asset('frontend/images/'); ?>/notification-img-2.png" alt=""></a>
                                                </div>
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img src="<?php echo asset('frontend/images/'); ?>/notification-img-3.png" alt=""></a>
                                                </div>
                                                <div class="media-body">
                                            ...
                                            <div class="media">
                                                <div class="media-left">
                                                    <a href="#"><img src="<?php echo asset('frontend/images/'); ?>/notification-img-4.png" alt=""></a>
                                                </div>
                                                <div class="media-body">
                            ...
                            <li class="partner-btn">
                                <a href="<?php echo route('frontend.become-a-partner'); ?>" class="b-btn btn-link">Become a Partner</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php /**PATH /opt/lampp/htdocs/fods/resources/views/frontend/partials/_menu.blade.php ENDPATH**/ ?>