<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        <!--begin::Logo-->
        <a href="<?php echo URL::to('/dashboard'); ?>" class="brand-logo">
            <img alt="logo" src="<?php echo asset('uploads'); ?>/logo/<?php echo $gd['globals']->admin_logo ?? ''; ?>" style="width: 100%; height: 50px;">
        </a>
        <!--end::Logo-->
        <!--begin::Toggle-->
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item menu-item-active" aria-haspopup="true">
                    <a href="<?php echo URL::to('/dashboard'); ?>" class="menu-link">
                        ...
                        <span class="menu-text">
                            <?php echo __('backend_menus.dashboard'); ?>
                ...
                <?php echo $__env->make('backend.inc.menu_list', array(
                ...
                <?php echo $__env->make('backend.inc.menu_list', array(
                    ...
                    'submenus'=>[
                        ['link'=>route('backend.delivery.driver-list'), 'text'=>'Drivers', 'access'=>'allowed'],
                        ['link'=>route('backend.delivery.transaction_list'), 'text'=>'Sales Transaction', 'access'=>'allowed'],
                        ['link'=>route('backend.delivery.payment.make_a_payment'), 'text'=>'Make a payment', 'access'=>'allowed'],
                    ]
                ), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <!-- Begin::Customer -->
                <?php echo $__env->make('backend.inc.menu_list', array(
                    'menu'=>__('backend_menus.customer'),
                    'submenus'=>[
                        ['link'=>route('backend.customer.list'), 'text'=>__('backend_menus.customer'), 'access'=>'allowed'],
                    ]
                ), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- End::customer -->
                ...
                <!-- Begin::Coupon -->
                <?php echo $__env->make('backend.inc.menu_list', array(
                    'menu'=>__('backend_menus.discount_coupon'),
                    'submenus'=>[
                        ['link'=>route('backend.settings.coupons'), 'text'=>__('backend_menus.coupons'), 'access'=>'allowed']
                    ]
                ), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- End::Coupon -->
                ...
                <!-- Begin::Reporting -->
                <?php echo $__env->make('backend.inc.menu_list', array(
                    'menu'=>__('backend_menus.reporting'),
                    'submenus'=>[
                        ['link'=>'javascript:;', 'text'=>__('backend_menus.sales_report'), 'access'=>'allowed'],
                        ['link'=>'javascript:;', 'text'=>__('backend_menus.expenses_report'), 'access'=>'allowed'],
                        ['link'=>'javascript:;', 'text'=>__('backend_menus.profit'), 'access'=>'allowed'],
                        ['link'=>'javascript:;', 'text'=>__('backend_menus.restaurant'), 'access'=>'allowed'],
                        ['link'=>'javascript:;', 'text'=>__('backend_menus.driver'), 'access'=>'allowed'],
                    ]
                ), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- End::Reporting -->
                ...
                <!-- Begin::Setting -->
                <?php echo $__env->make('backend.inc.menu_list', array(
                    'menu'=>__('backend_menus.setting'),
                    'submenus'=>[
                        ['link'=>route('backend.settings.global_settings'), 'text'=>__('backend_menus.global_settings'), 'access'=>'allowed'],
                        ['link'=>route('backend.settings.ccc'), 'text'=>__('backend_menus.country'), 'access'=>'allowed'],
                        ['link'=>route('backend.settings.payments'), 'text'=>__('backend_menus.payments'), 'access'=>'allowed'],
                        ['link'=>route('backend.settings.language'), 'text'=>__('backend_menus.language'), 'access'=>'allowed'],
                    ]
                ), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!-- End::Setting -->
                ...
                <?php echo $__env->make('backend.inc.menu_list', array(
                    'menu'=>__('backend_menus.content_management'),
                    'submenus'=>[
                        ['link'=>route('backend.content.contactInfo'), 'text'=>__('backend_menus.contact_info'), 'access'=>'allowed'],
                        ['link'=>'javascript:;', 'text'=>__('backend_menus.about_us_info'), 'access'=>'allowed'],
                    ]
                ), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /opt/lampp/htdocs/fods/resources/views/backend/partials/_aside_bar.blade.php ENDPATH**/ ?>