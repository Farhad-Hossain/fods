...
<!--begin::Main-->
<!--begin::Header Mobile-->
    <?php echo $__env->make('backend.partials._mobile_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!--end::Header Mobile-->
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <?php if(Auth::user()->role == 0): ?>
            <?php echo $__env->make('backend.partials._aside_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if(Auth::user()->role == 1): ?>
            <?php echo $__env->make('backend.restaurant.partials._aside_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <?php if(Auth::user()->role == 2): ?>
            <?php echo $__env->make('backend.driver.partials._aside_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
        <!--end::Aside-->
        <!--begin::Wrapper-->
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="header-menu-wrapper header-menu-wrapper-left" id="kt_header_menu_wrapper">
                        ...
                        <div id="kt_header_menu" class="header-menu header-menu-mobile header-menu-layout-default">
                            <!--begin::Header Nav-->
                            <?php echo $__env->make('backend.partials._header_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!--end::Header Nav-->
                        </div>
                        <!--end::Header Menu-->
                    </div>
                    ...
                    <!--begin::Topbar-->
                    <?php echo $__env->make('backend.partials._top_toolbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--end::Topbar-->
                </div>
                <!--end::Container-->
            </div>
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                <!--begin::Subheader-->
                <?php echo $__env->make('backend.partials._sub_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <!--end::Subheader-->
                <!--begin::Entry-->
...
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    <!--begin::Header-->
    <?php echo $__env->make('backend.partials._header_user_profile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end::Content-->
</div>
<!-- end::User Panel-->
...
<?php /**PATH /opt/lampp/htdocs/fods/resources/views/backend/master.blade.php ENDPATH**/ ?>