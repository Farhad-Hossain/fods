                                    ...
                                    <div class="filter-checkbox">
                                        <?php $__currentLoopData = $food_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <p>
                                              ...
                                              <label for="c13"> <?php echo e($category->name); ?></label>
                                            </p>
                                    ...
                                    <div class="filter-checkbox">
                                        <?php $__currentLoopData = $cuisines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cuisine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <p>
                                              ...
                                              <label for="c18"><?php echo e($cuisine->name); ?></label>
                                            </p>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>                                                                      
                                </div>
                    ...
                    <div class="row">
                            <?php if($foods->count() == 0): ?>
                                ...
                                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                                    <div class="all-meal">
                                        <div class="top">
                                            <a href="<?php echo e(route('frontend.food.details',$food->id)); ?>"><div class="bg-gradient"></div></a>
                                            <div class="top-img">
                                                <img src="<?php echo e(asset('uploads')); ?>/<?php echo e($food->image1); ?>" alt="" style="height: 170px;">
                                            </div>
                                            <div class="logo-img">
                                                <img src="<?php echo e(asset('uploads')); ?>/<?php echo e($food->restaurant->logo); ?>" alt="" style="width: 70px; height: 70px;">
                                            </div>
                                            <div class="top-text">
                                                <div class="heading"><h4><a href="meal_detail.html"><?php echo e($food->food_name); ?></a></h4></div>
                                                <div class="sub-heading">
                                                <h5><a href="restaurant_detail.html"><?php echo e($food->restaurant->name); ?></a></h5>
                                                <p>$<?php echo e($food->price); ?></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="bottom">
                                            <div class="bottom-text">
                                                <div class="delivery"><i class="fas fa-shopping-cart"></i>Delivery Free : $<?php echo e($food->restaurant->delivery_charge); ?></div>
...
<?php $__env->startSection('custom_script_files'); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.master', ['title'=>'Foods'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/fods/resources/views/frontend/pages/conditional_food_list.blade.php ENDPATH**/ ?>