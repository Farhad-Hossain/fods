					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="all-tabs">
							...
							<li class ="nav-item" role="presentation">
								<a href="#comments" class="nav-link active" aria-controls="comments" role="tab" data-toggle="tab">05 Comments</a>
							</li>
							<li class ="nav-item" role="presentation">
								...
								<div class="tab-pane" role="tabpanel" id="reviews">
									<div class="comment-post">
										<div class="post-items">
											...
											<form>
												<input type="text" class="rating-input" name="post" placeholder="Please describe the reason for your rating to help the author">
							...
							<div class="Extra-option">
								...
								<div class="non-veg">
									...
									<ul class="food-bootom">
										...
										<li>
											<p class="food-left">
												<input type="checkbox" value="{!! $extra_food->price !!}" id="c1_{!! $extra_food->id !!}" name="cb">
								...
								<div class="non-veg j-top">
									...
									<ul class="food-bootom">
										...
										<li>
											<p class="food-left">
												<input type="checkbox" value="{!! $extra_food->price !!}" id="c2_{!! $extra_food->id !!}" name="cb">
