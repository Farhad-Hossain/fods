                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="text" name="name" required class="form-control" placeholder="name of this food">
                        </div>
                        ...
                        <div class="form-group col-sm-12 col-md-6">
                            ...
                            <input type="number" class="form-control" name="price" required min="1" step="0.001" max="100" placeholder="Price of this food">
                        </div>
