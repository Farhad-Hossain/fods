            ...
            <div class="col-sm-12 col-md-12">
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form" action="{!! route('backend.customer.payment_transaction') !!}" method="POST" enctype="multipart/form-data">
                          @csrf
                             ...
                             <div class="form-group">
                                 <label>{!! __('transaction.select_customer') !!} <b class="text-info" id="wallet_amount"></b></label>
                                <select name="transaction_to_id" class="form-control selectpicker" required data-size="7" data-live-search="true">
                                  @foreach($reliable_target_users as $customer)
                                    <option value="{!! $customer->user->id !!}">{!! $customer->user->name !!} - ({!! $customer->phone_number !!})</option>
                                  @endforeach
                                </select>
                             </div>
                             <div class="form-group">
