...
<html lang="en">
	...
	<head><base href="../../../">
		<meta charset="utf-8" />
		<title>Food Delivery | Login Page 1</title>
			...
			<div class="login login-1 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
						...
						<!--end::Aside header-->
						<!--begin::Aside title-->
						<h3 class="font-weight-bolder text-center font-size-h4 font-size-h1-lg" style="color: #986923;">Amazing Food Delivery System
						<br />with great access</h3>
						<!--end::Aside title-->
					</div>
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
						...
						<div class="login-form login-signin">
							...
							<form class="form" novalidate="novalidate" id="kt_login_signin_form">
								...
								<div class="pb-13 pt-lg-0 pt-5">
									<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Welcome to Food Delivery System</h3>
