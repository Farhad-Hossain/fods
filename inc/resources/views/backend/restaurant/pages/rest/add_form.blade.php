        ...
        <div class="card card-custom">
            <div class="card-header">
                <div class="card-title">
                    ...
                    <h3 class="card-label">Create Restaurant</h3>
                </div>
            ...
            <!--begin::Form-->
            <form class="form" action="{!! route('backend.restAdmin.rest.add_submit') !!}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
               ...
               <div class="row">
                   ...
                   <div class="form-group col-sm-12 col-md-4">
                       ...
                       <input type="text" class="form-control" name="restaurant_latitude" placeholder="Insert Latitude">
                   ...
                   <div class="form-group col-sm-12 col-md-4">
                       ...
                       <input type="text" class="form-control" name="restaurant_longitude" placeholder="Insert longitutde">
